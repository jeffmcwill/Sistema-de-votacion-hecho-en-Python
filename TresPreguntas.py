...
def TresPreguntas():
	...
	while True:
		...
		try:
			...
			if sumaLista(listas1) > sumaLista(listas2) and sumaLista(listas1) > sumaLista(listas3):
				print("//////////////////////////////////////////////")
				print("La opcion 1 es elegida por la mayoria de voto")
				print("//////////////////////////////////////////////")

			elif sumaLista(listas2) > sumaLista(listas1) and sumaLista(listas2) > sumaLista(listas3):
				print("//////////////////////////////////////////////")
				print("La opcion 2 es elegida por la mayoria de voto")
				print("//////////////////////////////////////////////")

			elif sumaLista(listas3) > sumaLista(listas1) and sumaLista(listas3) > sumaLista(listas2):
				print("//////////////////////////////////////////////")
				print("La opcion 3 es elegida por la mayoria de voto")
				print("//////////////////////////////////////////////")

			elif sumaLista(listas1) == sumaLista(listas2) and sumaLista(listas1) == sumaLista(listas3):
				print("////////////////////////////////////////////////")
